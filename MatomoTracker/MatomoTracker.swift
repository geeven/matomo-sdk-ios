...
extension MatomoTracker {
    ...
    @objc public func track(eventWithCategory category: String, action: String, name: String = "", number: NSNumber? = nil, url: URL? = nil, pc: String = "", module:String = "", component: String = "", ul: String = "",um: String = "",ua: String = "",jjbid: String = "", gd: String = "", jjs_s: Int = 0, jjs_l: String = "", jjs_r: String = "", jjs_dp: Float = 0, jjs_ctTwo: String = "", jjs_ctOne: Int = 0) {
    ...
    @objc public func track(eventWithCategory category: String, action: String, name: String = "", number: NSNumber? = nil, pc: String = "", module:String = "", component: String = "", ul: String = "",um: String = "",ua: String = "",jjbid: String = "", gd: String = "", jjs_s: Int = 0, jjs_l: String = "", jjs_r: String = "", jjs_dp: Float = 0, jjs_ctTwo: String = "", jjs_ctOne: Int = 0) {
