...
extension MatomoTracker {
    ...
    @objc public func track(eventWithCategory category: String, action: String, name: String = "", number: NSNumber? = nil, pc: String = "", module:String = "", component: String = "", ul: String = "",um: String = "",ua: String = "",jjbid: String = "", gd: String = "", jjs_s: Int = 0, jjs_l: String = "", jjs_r: String = "", jjs_dp: Float = 0, jjs_ctTwo: String = "", jjs_ctOne: Int = 0, jjs_cn: String = "", jjs_cs: String = "", jjs_cm: String = "", jjs_ck: String = "", jjs_cc: String = "", jjs_sc: Int = 0, jjs_uc: String = "", jjs_href: String = "", jjs_fx_uid: String = "" ) {
        track(eventWithCategory: category, action: action, name: name, number: number, url: nil, pc: pc, module: module, component: component, ul: ul, um:um, ua: ua, jjbid: jjbid, gd: gd, jjs_s: jjs_s, jjs_l: jjs_l, jjs_r: jjs_r,
              jjs_dp: jjs_dp, jjs_ctTwo: jjs_ctTwo, jjs_ctOne: jjs_ctOne, jjs_cn: jjs_cn, jjs_cs: jjs_cs, jjs_cm: jjs_cm, jjs_ck: jjs_ck, jjs_cc: jjs_cc, jjs_sc: jjs_sc, jjs_uc: jjs_uc, jjs_href: jjs_href, jjs_fx_uid: jjs_fx_uid)
    }
